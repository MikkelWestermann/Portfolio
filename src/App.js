    ...
    <div className="App">
      <Router>
        ...
        <Switch>
          <Route
            exact
            path="/demos/email-scheduler"
            component={EmailSchedulerPage}
          />
          <Route
            exact
            path="/demos/url-shortener"
            component={UrlShortenerPage}
          />
          <Route exact path="/games" component={Games} />
          <Route exact path="/" component={Landing} />
          <Route exact path="/game/privacy-policy" component={Privacy} />
        </Switch>
        <Footer />
      </Router>
    </div>
...
const Privacy = () => (
  <SubPage title="Privacy Policy">
    ...
    >
      <p>
        Mikkel Westermann built the game in question as an Ad Supported app.
        This SERVICE is provided by Mikkel Westermann at no cost and is intended
        for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Mikkel Westermann Game
      ...
      <p>This policy is effective as of 2020-05-20</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at mikkel.westermann.98@gmail.com.
      </p>{" "}
      <p>
